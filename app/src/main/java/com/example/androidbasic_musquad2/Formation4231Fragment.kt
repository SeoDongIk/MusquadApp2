...
class Formation4231Fragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view : View = inflater.inflate(R.layout.formation4231, container, false)
        val btnSt : ImageButton = view.findViewById(R.id.st4231)
        val btnLw : ImageButton = view.findViewById(R.id.lw4231)
        val btnCam : ImageButton = view.findViewById(R.id.cam4231)
        val btnRw : ImageButton = view.findViewById(R.id.rw4231)
        val btnLdm : ImageButton = view.findViewById(R.id.ldm4231)
        val btnRdm : ImageButton = view.findViewById(R.id.rdm4231)
        val btnLb : ImageButton = view.findViewById(R.id.lb4231)
        val btnLcb : ImageButton = view.findViewById(R.id.lcb4231)
        val btnRcb : ImageButton = view.findViewById(R.id.rcb4231)
        val btnRb : ImageButton = view.findViewById(R.id.rb4231)
        val btnGk : ImageButton = view.findViewById(R.id.gk4231)

        btnSt.setOnClickListener(this)
        btnLw.setOnClickListener(this)
        btnCam.setOnClickListener(this)
        btnRw.setOnClickListener(this)
        btnLdm.setOnClickListener(this)
        btnRdm.setOnClickListener(this)
                ...
                100->{
                    ...
                    when(position){
                        0->{
                            ...
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.st4231)
                        ...
                        1->{
                            Log.d("Toast", "1")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.lw4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        2->{
                            Log.d("Toast", "2")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.cam4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        3->{
                            Log.d("Toast", "3")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.rw4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        4->{
                            Log.d("Toast", "4")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.ldm4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        5->{
                            Log.d("Toast", "5")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.rdm4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        6->{
                            Log.d("Toast", "6")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.lb4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        7->{
                            Log.d("Toast", "7")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.lcb4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        8->{
                            Log.d("Toast", "8")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.rcb4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        9->{
                            Log.d("Toast", "9")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.rb4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
                        ...
                        10->{
                            Log.d("Toast", "10")
                            Log.d("Toast", player_image_src.toString()+player_name.toString())
                            val imageButton : ImageButton? = getView()?.findViewById(R.id.gk4231)
                            imageButton?.setImageResource(player_image_src)
                            Toast.makeText(context, player_name, Toast.LENGTH_SHORT).show()
    ...
    fun setImageResource(list: List<Int>){
        ...
        val btnSt : ImageButton = mainActivity.findViewById(R.id.st4231)
        val btnLw : ImageButton = mainActivity.findViewById(R.id.lw4231)
        val btnCam : ImageButton = mainActivity.findViewById(R.id.cam4231)
        val btnRw : ImageButton = mainActivity.findViewById(R.id.rw4231)
        val btnLdm : ImageButton = mainActivity.findViewById(R.id.ldm4231)
        val btnRdm : ImageButton = mainActivity.findViewById(R.id.rdm4231)
        val btnLb : ImageButton = mainActivity.findViewById(R.id.lb4231)
        val btnLcb : ImageButton = mainActivity.findViewById(R.id.lcb4231)
        val btnRcb : ImageButton = mainActivity.findViewById(R.id.rcb4231)
        val btnRb : ImageButton = mainActivity.findViewById(R.id.rb4231)
        val btnGk : ImageButton = mainActivity.findViewById(R.id.gk4231)

        btnSt.setImageResource(player_image_src_0)
        btnLw.setImageResource(player_image_src_1)
        btnCam.setImageResource(player_image_src_2)
        btnRw.setImageResource(player_image_src_3)
        btnLdm.setImageResource(player_image_src_4)
        btnRdm.setImageResource(player_image_src_5)
